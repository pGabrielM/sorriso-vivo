    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mb-4 text-gray-400">
              Clínica odontológica especializada em cuidar do seu sorriso com tecnologia de ponta e
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#equipe" className="transition-colors hover:text-white">
                  Equipe
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#agendamento" className="transition-colors hover:text-white">
                  Agendamento
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>📧 contato@sorrisovivo.com.br</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} Sorriso Vivo - Clínica Odontológica. Todos os direitos
            reservados.
          </p>
        </div>
      </div>
