      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-4 flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-teal-400">Odontologia Moderna</span>
              </div>
            </div>
            <p className="mb-6 max-w-md leading-relaxed text-gray-400">
              Clínica odontológica especializada em transformar sorrisos com tecnologia de última
              geração, equipe altamente qualificada e atendimento humanizado em Curitiba.
            </p>
            <div className="flex space-x-4">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-800 text-gray-400 transition-all hover:bg-teal-600 hover:text-white"
        ...
        <div className="mt-8 border-t border-gray-800 pt-8">
          <div className="text-center">
            <h4 className="mb-2 font-semibold text-white">Horário de Atendimento</h4>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
          <p>
            &copy; {new Date().getFullYear()} {contactInfo.clinic} - Todos os direitos reservados.
          </p>
          <p className="mt-2 text-xs">
            CRO-PR: Estabelecimento Odontológico Registrado • CNPJ: 00.000.000/0001-00
          </p>
        </div>
      </div>
    </footer>
